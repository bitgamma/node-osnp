...
exports.parseFrame = function(frame, securityLevel) {
  ...
  if (osnpFrame.hasSecurityEnabled() && securityLevel) {
    switch(securityLevel) { 
    case SecurityLevel.NONE:
    case SecurityLevel.AES_CTR:
      micLen = 0;
      break;
    case SecurityLevel.AES_CCM_128:
    case SecurityLevel.AES_CBC_MAC_128:
      micLen = 16;
      break;
    case SecurityLevel.AES_CCM_64:
    case SecurityLevel.AES_CBC_MAC_64:
      micLen = 8;
      break;
    case SecurityLevel.AES_CCM_32:
    case SecurityLevel.AES_CBC_MAC_32:
      micLen = 4;
      break;
    }
  } else {
  ...
  osnpFrame.payload = frame.slice(index, frame.length - micLen - 2);

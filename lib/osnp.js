...
exports.createFrameCounterAlign = function(counter, shortAddress) {
  var frameControlLow = exports.makeFrameControlLow(FrameType.MAC_CMD, true, false, true, true);
  var frameControlHigh = exports.makeFrameControlHigh(AddressingMode.SHORT_ADDRESS, AddressingMode.EUI);
  ...
  frame.payload = new Buffer(5);
  frame.payload[0] = MACCommand.FRAME_COUNTER_ALIGN;
  frame.payload.writeUInt32LE(counter, 1);
...
exports.parseFrame = function(frame) {
  ...
  var micLen = osnpFrame.hasSecurityEnabled() ? 8 : 0;

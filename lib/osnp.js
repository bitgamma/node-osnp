...
exports.createPairingCommand = function(eui, shortAddress) {
  var frameControlLow = exports.makeFrameControlLow(FrameType.MAC_CMD, false, false, true, false);
  var frameControlHigh = exports.makeFrameControlHigh(AddressingMode.EUI, FrameVersion.V2003, AddressingMode.SHORT_ADDRESS);
  ...
  frame.payload = new Buffer([MACCommand.ASSOCIATION_REQUEST, shortAddress[0], shortAddress[1]]);
  return frame;
}

exports.createUnpairingCommand = function(shortAddress) {
  var frameControlLow = exports.makeFrameControlLow(FrameType.MAC_CMD, false, false, true, false);
  var frameControlHigh = exports.makeFrameControlHigh(AddressingMode.SHORT_ADDRESS, FrameVersion.V2003, AddressingMode.NOT_PRESENT);
...
exports.createDiscoveryRequest = function() {
  ...
  var frameControlHigh = exports.makeFrameControlHigh(AddressingMode.SHORT_ADDRESS, FrameVersion.V2003, AddressingMode.SHORT_ADDRESS);
...
exports.createCommandPacket = function(eui, shortAddress, paired) {
  var frameControlLow = exports.makeFrameControlLow(FrameType.DATA, false, false, true, false);
  var frameControlHigh;
  
  if (paired) {
    frameControlHigh = exports.makeFrameControlHigh(AddressingMode.SHORT_ADDRESS, FrameVersion.V2003, AddressingMode.NOT_PRESENT);
  } else {
    frameControlHigh = exports.makeFrameControlHigh(AddressingMode.EUI, FrameVersion.V2003, AddressingMode.SHORT_ADDRESS);    
  }
